      ...
      <div className='container-fluid' id='About'>
        <div className='row about' data-aos="zoom-out-right">
          ...
          <div className='col-md-6 d-grid align-items-center mt-5 mb-5'>
            ...
            <p>My name is Rohan Singh. I'm a BTECH student at Oriental Institute of Science and Technology in Information Technology. I was born and raised in Bhopal. I completed my Diploma in Computer Science from Sardar Vallabhbhai Patel Polytechnic, Bhopal.</p>
            <p>I enjoy traveling, playing cricket, volleyball, and coding. I believe that traveling provides a new perspective on everything. It exposes you to different cultures, cuisines, history, languages, and unique aspects of each place.</p>
